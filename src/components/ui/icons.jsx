...
export const ArrowLeftRightIcon = ({ className = "" }) => (
  <svg
    ...
    strokeLinecap="round"
    strokeLinejoin="round"
    className={`lucide lucide-arrow-left-right ${className}`}
  >
...
// Additional icons that might be useful for your library app
...
export const TriangleAlertIcon = ({ className = "" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="24"
    height="24"
...
export const BookIcon = ({ className = "" }) => (
  <svg
    ...
    strokeLinecap="round"
    strokeLinejoin="round"
    className={`lucide lucide-book ${className}`}
  >
...
export const EyeIcon = ({ className = "" }) => (
  ...
  >
    <path d="M1 12s5-8 11-8 11 8 11 8-5 8-11 8-11-8-11-8z"></path>
...
export const PencilIcon = ({ className = "" }) => (
  ...
  >
    ...
    <path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7.5 18H4v-3.5l11.5-11.5z"></path>
  </svg>
);
...
export const UserCogIcon = ({ className = "" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="24"
    height="24"
    ...
    strokeLinecap="round"
    strokeLinejoin="round"
    className={`lucide lucide-house-cog ${className}`}
  >
    <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path>
    <path d="M9 21v-6h4v6"></path>
    <path d="M16 17l-2 2-2-2"></path>
  </svg>
);

export const ChartColumnIcon = ({ className = "" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="24"
    height="24"
    ...
    strokeLinecap="round"
    strokeLinejoin="round"
    className={`lucide lucide-chart-column ${className}`}
  >
    <path d="M3 21V3"></path>
...
export const HistoryIcon = ({ className = "" }) => (
  <svg
    ...
    stroke-linecap="round"
    stroke-linejoin="round"
    className={`lucide lucide-history h-4 w-4 ${className}`}
  >
...
export const TrashIcon = ({ className = "" }) => (
  <svg
    ...
    stroke-linecap="round"
    stroke-linejoin="round"
    className={`lucide lucide-trash2 h-4 w-4 ${className}`}
  >
    <path d="M3 6h18"></path>
...
export const ChevronDown = ({ className = "" }) => (
  <svg
    ...
    stroke-linecap="round"
    stroke-linejoin="round"
    className={`lucide lucide-chevron-down h-4 w-4 ${className}`}
  >
...
export const ChevronUp = ({ className = "" }) => (
  <svg
    ...
    stroke-linecap="round"
    stroke-linejoin="round"
    className={`lucide lucide-chevron-up h-4 w-4 ${className}`}
  >
...
export const TrendingUpIcon = ({ className = "" }) => (
  <svg
    ...
    stroke-linecap="round"
    stroke-linejoin="round"
    className={`lucide lucide-trending-up h-4 w-4 ${className}`}
  >
...
export const CheckCircleIcon = ({ className = "" }) => (
  <svg
    ...
    stroke-linecap="round"
    stroke-linejoin="round"
    className={`lucide lucide-check-circle h-4 w-4 ${className}`}
  >
...
export const XCircleIcon = ({ className = "" }) => (
  <svg
    ...
    stroke-linecap="round"
    stroke-linejoin="round"
    className={`lucide lucide-x-circle h-4 w-4 ${className}`}
  >
...
export const FileTextIcon = ({ className = "" }) => (
  <svg
    ...
    strokeLinecap="round"
    strokeLinejoin="round"
    className={`lucide lucide-file-text h-4 w-4 ${className}`}
  >
...
export const Trash2Icon = ({ className = "" }) => (
  <svg
    ...
    strokeLinecap="round"
    strokeLinejoin="round"
    className={`lucide lucide-trash-2 h-4 w-4 ${className}`}
  >
